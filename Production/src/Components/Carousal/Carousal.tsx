        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            <motion.div
              ...
              className="w-full max-w-5xl mx-auto bg-white dark:bg-neutral-900 h-fit z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative"
            >
              <button
                className="sticky z-40 top-4 h-8 w-8 right-0 ml-auto bg-black dark:bg-white rounded-full flex items-center justify-center"
                onClick={handleClose}
              >
